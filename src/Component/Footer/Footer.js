...
const Footer = () => {
  return (
    <div>
      <footer className="footer footer-center mt-10 p-10 bg-base-100 border-t border-gray-700 text-base-content rounded">
        ...
        <div>
          <p>Copyright @ 2025-All Right Reserved By Hazrat Ali</p>
        </div>
      </footer>
    </div>
  );
